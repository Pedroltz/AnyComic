...
{
    /// <summary>
    /// Represents a written review with a star rating left by a user on an anime.
    /// Mirrors the <see cref="ReviewManga"/> entity used for mangas.
    /// Each user can have at most one review per anime (enforced by a unique index).
    /// </summary>
    public class ReviewAnime
    {
        /// <summary>
        ...
        /// <summary>
        /// Foreign key to the reviewed anime
        /// </summary>
        [Required]
        ...
        /// </summary>
        public ICollection<ReviewReplyAnime> Replies { get; set; } = new List<ReviewReplyAnime>();
    }
}
