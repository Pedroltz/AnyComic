...
namespace AnyComic.Migrations
{
    ...
    [Migration("20260704145556_AddChapterReadTracking")]
    partial class AddChapterReadTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnyComic.Models.Capitulo", b =>
                {
                    ...
                    b.Property<string>("FonteCapituloId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("AnyComic.Models.CapituloLido", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UsuarioId", "CapituloId")
                        .IsUnique();

                    b.HasIndex("UsuarioId", "MangaId");

                    b.ToTable("CapitulosLidos");
                });
